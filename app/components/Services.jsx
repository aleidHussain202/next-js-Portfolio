...
const Services = () => {
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I offer a range of services to help you create a website that is both visually stunning and functional.</motion.p>
