...
const About = ({isDarkMode}) => {
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20 flex flex-col items-center justify-center text-center ' >
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            transition={{duration: 0.6}}>
                <Image src={assets.user_image} alt="Profile Image" className='w-full rounded-3xl' />
            </motion.div> */}
            ...
            className='flex-1'>
                ...
                <p className='mb-10 font-Ovo'>I am a newly graduated frontend web developer with a passion for creating dynamic and user-friendly websites and applications. And I always eager to learn new things and improve my skills.</p>
                </div>
                ...
                className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl'>
                    {infoList.map(({icon, iconDark, title, description},index)=> (<motion.li 
